  ...
  return (
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* Bottom area */}
        <div className="md:flex md:items-center md:justify-between py-4 md:py-2 border-t border-gray-300">
          ...
          <div className="text-sm text-gray-600 mr-4">&copy; Parivesh Srivastava. All rights reserved.</div>
        </div>
      </div>
    </footer>
  )
